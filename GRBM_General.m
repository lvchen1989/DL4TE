...
%output of the function：params1~4 are parameters to train the GRBM
...
% n：the number of cases in each batch
% d：the dimension of each case
%nBatches：the number of batches
